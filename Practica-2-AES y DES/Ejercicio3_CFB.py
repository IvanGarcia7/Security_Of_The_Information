...
class AES_CIPHER:
    ...
    def cifrar(self, cadena, IV):
        ...
        # Creamos un mecanismo de cifrado AES en modo CFB con una inicializacion IV
    ...
    def descifrar(self, cifrado, IV):
        # Creamos un mecanismo de (des)cifrado AES en modo CFB con una inicializacion IV
...
print("AES Modo de Operacion CFB:")
